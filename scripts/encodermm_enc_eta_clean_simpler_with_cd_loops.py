...
# Date: 2023/11/30
# Mieke
# This is a version extended with dwn transitions also for tau-transitions
# as defined in the eta-encoding by Vincenzo
...
#                   Add also in this case dwn transitions: 
